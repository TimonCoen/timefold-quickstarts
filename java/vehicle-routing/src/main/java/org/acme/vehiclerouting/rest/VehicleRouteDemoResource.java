...
public class VehicleRouteDemoResource {
    ...
    public enum DemoData {
        ...
        private LocalTime vehicleEndTime;
        ...
        DemoData(long seed, int visitCount, int vehicleCount, LocalTime vehicleStartTime, LocalTime vehicleEndTime,
    ...
    public VehicleRoutePlan build(DemoData demoData) {
        ...
        Supplier<Vehicle> vehicleSupplier = () -> new Vehicle(
                ...
                tomorrowAt(demoData.vehicleEndTime));
